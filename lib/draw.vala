...
namespace Draw {
	...
	public void draw_left_panel_rectangle(Context cr, int x, int y, int width, int height, double r, bool fill=true) {
        // Top side.
        cr.move_to(x, y);
	...
	public void draw_right_panel_rectangle(Context cr, int x, int y, int width, int height, double r, bool fill=true) {
        // Top side.
        cr.move_to(x, y);
        cr.line_to(x + width, y);
	...
	public void draw_titlebar_rectangle(Context cr, int x, int y, int width, int height, double r, bool fill=true) {
        // Top side.
        cr.move_to(x + r, y);
        cr.line_to(x + width - r, y);
